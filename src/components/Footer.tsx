    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 text-emerald-400">MSU</h4>
            ...
            <div className="mt-4 flex items-center space-x-2 text-gray-400 text-sm">
                ...
                <span>Faith Tabernacle, CanaanLand. Ota</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-center space-x-2">
                ...
                <a href="tel:(555) 123-4567" className="text-gray-400 hover:text-white transition">(234) 080-0000-0000</a>
              </li>
              <li className="flex items-center space-x-2">
                <Mail className="w-4 h-4 text-emerald-400" />
                <a href="mailto:info@healthbridge.com" className="text-gray-400 hover:text-white transition">info@msu.com</a>
              </li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 text-center text-gray-500 text-sm">
          &copy; {new Date().getFullYear()} MSU. All rights reserved.
        </div>
      </div>
    </footer>
);
